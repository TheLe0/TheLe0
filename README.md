...
- 🔭  I'm a Backend Developer, working on Web, Desktop and Mobile applications and APIs. Currently working mostly with Microsoft's technologies, such as Dynamics AX, .NET, Azure, SQL Server, SSRS, Power BI and some others;
- 💬  My Favorites programming languages are C#, Java, Javascript and Python;
